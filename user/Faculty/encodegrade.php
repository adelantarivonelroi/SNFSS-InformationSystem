  ...
  if (isset($_REQUEST['id']))
    {
      ...
      if (ctype_digit($_REQUEST['id']))
      {
        ...
        $lockbutton = "";
        #get subject section
        $sql_getsections = "SELECT DISTINCT s.SectionID, s.SectionName, l.LevelID, l.LevelName, fl.SchoolYearID, sy.SchoolYearStart, sy.SchoolYearEnd, s.SectionID, u.FirstName, u.MiddleName, u.LastName, su.SubjectID, su.SubjectName FROM facultylist fl 
        ...
        $sql_getgradestatus = "SELECT gs.GradeStatusID, gs.GradeTypeID, gt.GradeTypeName 
        FROM gradestatus gs 
        INNER JOIN gradetype gt 
        ON gs.GradeTypeID = gt.GradeTypeID 
        WHERE gs.GradeStatusID = 1";
              ...
              $txtboxes = isset($_POST['text_box']) ? $_POST['text_box'] : array();
               if(!empty($txtboxes)) {
                  foreach ($txtboxes as $inputgrade) {
                       $sql_addgrade = "INSERT INTO grade ( StudentListID, SubjectID, GradeStatusID, Grade ) VALUES ( $slid, $subjectid, $gtid, $inputgrade )";
                       $con->query($sql_addgrade) or die(mysqli_error($con));
                  }
                  $message = "Grades are submitted. Thank you.";
              }
        }
      }else
    {
              ...
              <div class=box-body>
                        ...
                        <div class="col-sm-7">
                          <div class="form-group">
                            ...
                            <div class="col-sm-4">
                              <label class="control-label col-sm-4"><?php echo $levelname ?></label>
                            </div>
                          </div>
                        </div>
                        <div class="col-sm-7">
                        ...
                        <div class="col-sm-7">
                          <div class="form-group">
                            <p class="control-label col-sm-2">Periodic Rating</p>
                            <div class="col-sm-6">
                              <label class="control-label col-sm-4"><?php echo $gsname ?></label>
                            </div>
                          </div>
                        </div>
                        <div class="col-sm-7">
                          <div class="form-group">
                            ...
                            <div class="col-sm-5">
                              <button name="encode" type="submit" class="btn btn-primary">Submit</button>
                              <?php echo $message ?>
                            </div>
                          </div>
