<?php
  ...
  if (isset($_POST['add']))
  {
      ...
      if (!preg_match('/^[a-zA-z0-9]+$/i', $street))
      {
        $error .= "<script type='text/javascript'>alert('Street is in incorrect format!')</script>"; 
      }
      if (!preg_match('/^[a-zA-z0-9]+$/i', $barangay))
      {
        $error .= "<script type='text/javascript'>alert('Barangay is in incorrect format!')</script>"; 
      }
      if (!preg_match('/^[a-zA-z0-9]+$/i', $pw))
      {
        $error .= "<script type='text/javascript'>alert('Password is in incorrect format!')</script>"; 
      }
      if (!preg_match('/^[a-zA-z0-9]+$/i', $rpw))
      {
        $error .= "<script type='text/javascript'>alert('Re-type password is in incorrect format!')</script>"; 
      }
      if(!preg_match('/^[a-zA-z0-9]+$/i', $uname)) 
      {
        $error .= "<script type='text/javascript'>alert('Username is in incorrect format!')</script>";
        
      }
      if(!preg_match('/^[a-zA-z]+$/i', $fn)) 
      {
        $error .= "<script type='text/javascript'>alert('First name is in incorrect format!')</script>";
        
      }
      if(!preg_match('/^[a-zA-z]+$/i', $ln)) 
      {
        $error .= "<script type='text/javascript'>alert('Last name is in incorrect format!')</script>";
            ...
            <form method="post">
              <div class="box-body">
                <div class="col-md-4">
                  ...
                  <input type="text" class="form-control" value="" name="uname" minlength="8" maxlength="20" required>
                </div>
                <div class="col-md-4">
                  <label class="control-label">Password(*)</label>
                   <input type="password" class="form-control" value="" name="pw" minlength="8" maxlength="30" required>
                </div>
                <div class="col-md-4">
                  <label class="control-label">Re-Type Password(*)</label>
                  <input type="password" class="form-control" value="" name="rpw" minlength="8" maxlength="30" required>
                </div>
              </div>
            ...
            <div class="box-header with-border">
              ...
              <div class="box-body">
                <div class="col-md-4">
                  ...
                  <input type="text" class="form-control" value="" name="fn" minlength="2" maxlength="30" required>
                </div>
                <div class="col-md-4">
                  <label class="control-label">Middle Name</label>
                   <input type="text" class="form-control" value="" name="mn" minlength="2" maxlength="30">
                </div>
                <div class="col-md-4">
                  <label class="control-label">Last Name(*)</label>
                   <input type="text" class="form-control" value="" name="ln" minlength="2" maxlength="30" required>
                </div>
              </div>
               <div class="box-body">
                <div class="col-md-4">
              ...
              <div class="box-body">
                <div class="col-md-4">
                  <label class="control-label">Contact No.</label>
                    <input type="number" class="form-control" value="" minlength="11" maxlength="11" name="contact">
                </div>
                <div class="col-md-4">
              ...
              <div class="box-body">
                ...
                <div class="col-md-4">
                  <label for="address" class="control-label">Street(*)</label>
                    <input type="text" name="Street"  class="form-control" minlength="3" maxlength="50" required>
                </div>

                <div class="col-md-4">
                  <label for="address" class="control-label">Barangay(*)</label>
                    <input type="text" name="Barangay"  class="form-control" minlength="3" maxlength="50"required>
                </div>
