...
if (isset($_POST["import"])) {
    ...
    if ($_FILES["file"]["size"] > 0) {
        ...
        while (($column = fgetcsv($file, 10000, ",")) !== FALSE) {
            $sqlInsert = "INSERT into address (AddressID, Street, Barangay, CityID)
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Import Address Record(s)</h3>
      </div>
            ...
            ?>
              <tbody>
                <tr>
                  ...
                  <td><?php  echo encrypt($row['Street']); ?></td>
                  <td><?php  echo encrypt($row['Barangay']); ?></td>
