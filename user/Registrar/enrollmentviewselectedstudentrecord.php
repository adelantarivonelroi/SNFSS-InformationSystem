            ...
            <form method="POST" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  <p class="col-sm-2 control-label">Image</p>
                  <div class="col-sm-2">
                   <img src='<?php echo app_path ?>user/Registrar/images/student/<?php echo $image ?>'  alt='No Picture Available' style="max-width: 200px; max-height: 130px;"/>
                 </div>
               </div>
