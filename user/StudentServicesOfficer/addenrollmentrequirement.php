  ...
  if ( isset($_POST['add'])) {
    ...
    else
    {
      ...
      move_uploaded_file($_FILES["pdf"]["tmp_name"], $file);
        ...
        $sql_addannoucement = "INSERT INTO post VALUES ( '', $uid, 2, '$title', '$description', '$newImage', '$newpdf', NOW(), NULL, 'Active' )";  
        ...
        <div class="col-md-12">
          ...
          <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title">Add New Enrollment Requirement</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
