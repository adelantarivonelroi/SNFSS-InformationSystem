<?php 
 ...
 $sql_viewsl = "SELECT sub.SubjectName, sl.SummerStudentListID, sl.LevelID, sl.DateCreated, sl.Status, s.SectionName, sy.SchoolYearStart, sy.SchoolYearEnd, l.LevelName, st.FirstName, st.MiddleName, st.LastName
  ...
  ON sl.SummerSectionID = s.SummerSectionID
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Pending summer class list approval</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                    ...
                    while ($row = mysqli_fetch_array($result_slpending))
                    {
                      ...
                      echo "
                        <tr>
                          ...
                          <td>$stat</td>
                          <td>
                            <a href='psummerclasslistapprove.php?id=$slid' class='btn btn-xs btn-success'>
                              Approve
                            </a>
                          </td>
                          <td>
                            <a href='psummerclasslistdisapprove.php?id=$slid' class='btn btn-xs btn-danger'>
                              Disapprove
                            </a>
                          </td>
                        </tr>
