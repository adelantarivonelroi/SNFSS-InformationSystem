<?php 
  ...
  $sql_pendingfl = "SELECT fl.SummerFacultyListID, fl.LevelID, fl.DateCreated, fl.Status, s.SectionName, sy.SchoolYearStart, sy.SchoolYearEnd, l.LevelName, sub.SubjectName, u.FirstName, u.MiddleName, u.LastName, fl.DateApproved
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Pending summer faculty list approval</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                    ...
                    <?php
                      while ($row = mysqli_fetch_array($result_pendingfl))
                      {
                        ...
                        <tr>
                            ...
                            <td>$stat</td>
                            <td>
                            <a href='psummerfacultylistapprove.php?id=$flid' class='btn btn-xs btn-success'>
                              Approve
                            </a>
                          </td>
                          <td>
                            <a href='psummerfacultylistdisapprove.php?id=$flid' class='btn btn-xs btn-danger'>
                              Disapprove
                            </a>
                          </td>
                          </tr>
