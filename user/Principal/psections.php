<?php 
  ...
  $sql_result = "SELECT s.*, sy.*, l.* FROM section s
                    ...
                    while ($row = mysqli_fetch_array($result_sql))
                    {
                      ...
                      echo "
                        <tr>
                          ...
                          <td>$sstat</td>
                          <td>
                          <a href='psectionsapprove.php?id=$sid' class='btn btn-xs btn-success'>
                            Approve
                          </a>
                          </td>
                          <td>
                          <a href='psectionsdisapprove.php?id=$sid' class='btn btn-xs btn-danger'>
                            Disapprove
                          </a>
                          </td>
