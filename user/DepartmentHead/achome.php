...
<aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li><a href="createfacultylist.php"><i class="fa fa-circle-o text-red"></i> <span>Manage faculty list</span></a></li>
            <li class="header">Student list</li>
            <li><a href="createstudentlist.php"><i class="fa fa-circle-o text-red"></i> <span>Manage student list</span></a></li>
            <li class="header">Sections</li>
            <li><a href="sectioncreate.php"><i class="fa fa-circle-o text-red"></i> <span>Manage sections</span></a></li>
          </ul>
          </section>
          <!-- /.sidebar -->
        </aside>
