<?php 
  ...
  $sql_disapprovedstudentlist = "SELECT sl.StudentListID, sl.LevelID, sl.DateCreated, sl.Status, s.SectionName, sy.SchoolYearStart, sy.SchoolYearEnd, l.LevelName, st.FirstName, st.MiddleName, st.LastName
  FROM studentlist sl
  ...
  WHERE sl.Status = 'Disapproved'";

  $result_disapprovedstudentlist = $con->query($sql_disapprovedstudentlist) or die(mysqli_error($con));
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">View approved student list proposals</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
             <table id="example3" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                    while ($row = mysqli_fetch_array($result_disapprovedstudentlist))
                    {
