<?php 
  ...
  $sql_pendingfacultylist = "SELECT fl.FacultyListID, fl.LevelID, fl.DateCreated, fl.Status, s.SectionName, sy.SchoolYearStart, sy.SchoolYearEnd, l.LevelName, sub.SubjectName, u.FirstName, u.MiddleName, u.LastName, ts.TimeForm
  FROM facultylist fl
  ...
  $result_pendingfacultylist = $con->query($sql_pendingfacultylist) or die(mysqli_error($con));
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">View pending faculty list proposals</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
             <table id="example3" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                    ...
                    while ($row = mysqli_fetch_array($result_pendingfacultylist))
                    {
