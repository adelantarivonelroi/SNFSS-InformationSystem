<?php 
  ...
  if (isset($_SESSION['sectionid']) && !empty($_SESSION['sectionid']) && isset($_SESSION['levelid']) && !empty($_SESSION['levelid']) && isset($_SESSION['sectionno']) && !empty($_SESSION['sectionno']))
  {
    ...
    $sql_viewselected = "SELECT fl.FacultyListID, fl.SectionID, fl.LevelID, s.SectionName, fl.Status, su.SubjectName, ts.TimeForm, u.FirstName, u.MiddleName, u.LastName
    FROM facultylist fl
