<?php 
  ...
  $sql_disapprovedsection = "SELECT s.*, sy.*, l.* FROM section s
  INNER JOIN schoolyear sy
  ON s.SchoolYearID = sy.SchoolYearID 
  INNER JOIN level l 
  ON s.LevelID = l.LevelID 
  WHERE SectionStatus = 'Disapproved'";

  $result_disapprovedsection = $con->query($sql_disapprovedsection) or die(mysqli_error($con));
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">View disapproved section proposals</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
             <table id="example3" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                    ...
                    while ($row = mysqli_fetch_array($result_disapprovedsection))
                    {
                      $sid = $row['SectionID'];
