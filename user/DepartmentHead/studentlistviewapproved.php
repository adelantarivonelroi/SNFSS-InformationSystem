<?php 
  ...
  $sql_approvedstudentlist = "SELECT sl.StudentListID, sl.LevelID, sl.DateCreated, sl.Status, s.SectionName, sy.SchoolYearStart, sy.SchoolYearEnd, l.LevelName, st.FirstName, st.MiddleName, st.LastName
  FROM studentlist sl
  ...
  $result_approvedstudentlist = $con->query($sql_approvedstudentlist) or die(mysqli_error($con));
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
             <table id="example3" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                    while ($row = mysqli_fetch_array($result_approvedstudentlist))
                    {
