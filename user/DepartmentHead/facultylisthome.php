<?php 
  ...
  {
    header('location: facultylistviewdisapproved.php');
  }
  if (isset($_POST['viewapproved']))
  {
    header('location: facultylistviewapproved.php');
  }
  if (isset($_POST['viewpending']))
  {
    header('location: facultylistviewpending.php');
  }
?>
...
<aside class="main-sidebar">
    ...
    <section class="content-header">
      <h1>
        Faculty list
        <small>manage faculty list</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">faculty list</a></li>
        <li class="active">Manage faculty list</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Manage faculty list</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="POST">
              <div class="box-body">
                    <div class="form-group">
                        <p class="col-sm-2 control-label">Create a faculty list proposal.</p>
                        <div class="col-sm-2">
                    ...
                    <div class="form-group">
                        <p class="col-sm-2 control-label">View pending faculty list proposal.</p>
                        <div class="col-sm-2">
                    ...
                    <div class="form-group">
                        <p class="col-sm-2 control-label">View approved faculty list proposal.</p>
                        <div class="col-sm-2">
                    ...
                    <div class="form-group">
                        <p class="col-sm-2 control-label">View disapproved faculty list proposal.</p>
                        <div class="col-sm-2">
