...
<div class="login-box">
  ...
  <div class="login-logo">
    ...
    <form action="index.php" method="POST">
      ...
      <div class="form-group has-feedback">
        <div class="g-recaptcha" data-theme="light" data-sitekey="6LeculEUAAAAAHEULDoI6UJLVUTtfD7xgSc4hAx-" style="transform:scale(1.20);-webkit-transform:scale(1.00);transform-origin:0 0;-webkit-transform-origin:0 0;">
        </div>
      </div>
